			...
			case 'tab_style':
				...
				return(
					...
					<Fragment>
						...
						<PanelBody title="Checkout Button" initialOpen={ false }>

							<PanelRow>

								<ColorPicker
									color={ attributes.checkoutButtonBackgroundColor }
									onChangeComplete={ ( value ) => setAttributes( { checkoutButtonBackgroundColor: value.hex } ) }
									disableAlpha
								/>
						...
						<PanelBody title="Continue Shopping Button" initialOpen={ false }>

							<PanelRow>

								<ColorPicker
									color={ attributes.continueShoppingButtonBackgroundColor }
									onChangeComplete={ ( value ) => setAttributes( { continueShoppingButtonBackgroundColor: value.hex } ) }
									disableAlpha
								/>
