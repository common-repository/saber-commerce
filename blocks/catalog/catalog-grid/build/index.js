(window["webpackJsonp_catalog_grid"] = window["webpackJsonp_catalog_grid"] || []).push([["style-index"],{
...
/******/
/******/ 	var jsonpArray = window["webpackJsonp_catalog_grid"] = window["webpackJsonp_catalog_grid"] || [];
...
function Edit() {
  const ALLOWED_BLOCKS = ['saber-commerce/catalog-grid-item-template'];
  const TEMPLATE = [['saber-commerce/catalog-grid-item-template', {}]];
...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__["registerBlockType"])('saber-commerce/catalog-grid', {
