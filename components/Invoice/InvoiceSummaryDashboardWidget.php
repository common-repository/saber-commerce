...
class InvoiceSummaryDashboardWidget extends \SaberCommerce\Component\Admin\SummaryWidget {

	function headingText() {

		return __( 'INVOICES SUMMARY', 'saber-commerce' );
	...
	function statLabel() {
		...
		return __( 'Total Invoices', 'saber-commerce' );
	...
	function latestHeading() {
		...
		return __( 'New Invoices', 'saber-commerce' );
	...
	function buttonLabel() {
		...
		return __( 'Add Invoice', 'saber-commerce' );

	}

	function buttonUrl() {

		return '?page=sacom-invoices';
