...
class ProductSummaryDashboardWidget extends \SaberCommerce\Component\Admin\SummaryWidget {

	function headingText() {

		return __( 'PRODUCTS SUMMARY', 'saber-commerce' );
	...
	function statLabel() {
		...
		return __( 'Total Products', 'saber-commerce' );
	...
	function latestHeading() {
		...
		return __( 'New Products', 'saber-commerce' );
	...
	function buttonLabel() {
		...
		return __( 'Add Product', 'saber-commerce' );

	}

	function buttonUrl() {

		return '?page=sacom-products';
